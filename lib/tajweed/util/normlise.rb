...
module GQTool::Tajweed::Utils
  ...
  class CharacterInfo
    ...
    def initialize(
      common: common_glyph,
      isolated: isolated_glyph,
      final: final_glyph,
      initial: initial_glyph,
      medial: medial_glyph,
      connects: connects?,
      diacritic: diacritic?
    )
  ...
  def self.charinfos
    ...
    add("0628", "fe8f", "fe90", "fe91", "fe92", true)        # Ba
    add("062a", "fe95", "fe96", "fe97", "fe98", true)        # Ta
    add("062b", "fe99", "fe9a", "fe9b", "fe9c", true)        # Tha
    add("062c", "fe9d", "fe9e", "fe9f", "fea0", true)        # Jeem
    add("062d", "fea1", "fea2", "fea3", "fea4", true)        # Ha
  ...
  def self.add(common, isolated, final, initial, medial, connects, diacritic = false)
    @@charinfos[charinfo.common] = CharacterInfo.new(
      common:    common.to_glyph,
      isolated:  isolated.to_glyph,
      final:     final.to_glyph,
      initial:   initial.to_glyph,
      medial:    medial.to_glyph,
      connects:  connects,
      diacritic: diacritic
    )
  end
